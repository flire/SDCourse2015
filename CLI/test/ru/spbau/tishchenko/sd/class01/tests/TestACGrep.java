...
import ru.spbau.tishchenko.sd.class01.commands.grep.apachecli.ACGrepCommand;
import ru.spbau.tishchenko.sd.class01.shell.IShell;
import ru.spbau.tishchenko.sd.class01.test.TestingShell;

public class TestACGrep {

	private static final String ENCODING = "UTF-8";

	private static ACGrepCommand command;
	private static IShell testShell;

	@BeforeClass
	public static void setup() {
		command = new ACGrepCommand();
